...
Blockchain, like the internet, is just a new form of technology. While there are many jobs that work directly on providing and maintaing web infrastructure, there are far more careers today that use the internet as a tool to do meaningful work in other industries. Therefore, practioners should be aware of not only presently existing career oppotunities, but think about how they could create opportunities in more fields as the technological adoption increases.
...
- Work in rapidly evolving space that allows for continuous learning.
- Solve challenging problems with overlapping implicaitons in the fields of technology, finance, ethics, and social policy.
- In demand and high-paying ([Lucas, 2020](https://academic.oup.com/itnow/article-abstract/62/4/20/6047516?redirectedFrom=fulltext))
...
- Blockchain often operates in an undefined regulatory space for many fields; Incomming regulation can cause disruption.
...
According to ["How to start a career in Blockchain"](https://academic.oup.com/itnow/article-abstract/62/4/20/6047516?redirectedFrom=fulltext), an article from IBM's Blockchain Enablement Lead, there are three categories of roles in this field. These categories are not meant to be mutually exclusive, but instead provide a framework to understand the types of activities that different positions are focusin on. 
...
Users of this guide are encouraged to assess their backgrounds and ambitions to figure out which sort of role appeals to them. Practionners in each of the categories above should be ready to get technical, but a high-level understanding of the building blocks of blockchain techology is prefable to specializing in details too soon, especially considering how quickly the technology can change.
...
Practioners without programming experience should not be dissuaded from participating in this space. If one can understand the value propositions of this technology and develop a convincing use case, one can instead work like a product manager, creating requirements and specificaitons for the project and hiring a developer to do the building.
...
The following is a summary of overall job responsibilites and skill requirments acquired through a topic model analysis of 42 avialable blockchain jobs from 29 companies. Though the jobs themselves were not initially categorized by each role, the results were analyzed through the lens of the 3 job roles.
...
### Key Skills
*Note: The key skills in this section are be heavily biased towards a techincal skillset because technical roles are more likely to require experience with a large set of specific tools.*
